...
//ref: http://forum.unity3d.com/threads/none-rectangle-shaped-button.263684/#post-1744521
//This script does a raycast check on a Unity (4.6+/new UI) UI button using alpha mask checking,
//such that events are not triggered outside an odd shaped (any shape) image.
//Clicking on any any zero alpha area in the image makes the the raycast return false 
//(aka not hit, and clicking through). 
//The Sprite MUST be: texture type to Advanced and checking the Read/Write Enabled checkbox
//
//Drag this onto a Unity5 UI button
//note. Stop using "var" fools!

[RequireComponent(typeof(RectTransform))]
[RequireComponent(typeof(Image))]
public class UIButtonRaycastMask : MonoBehaviour, ICanvasRaycastFilter {
    ...
    public bool IsRaycastLocationValid(Vector2 sp, Camera eventCamera) {
        ...
        try {
            //Debug.Log("IsRaycastLocationValid returning " + (_sprite.texture.GetPixel(x, y).a > 0));
