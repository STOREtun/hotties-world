...
namespace UnityConstants
{
    public static class Tags
    {
        ...
        public const string OVERLAY_BTN_CLOSE       = "OVERLAY_BTN_CLOSE";
        public const string OVERLAY_BTN_NEXT        = "OVERLAY_BTN_NEXT";
        public const string WORLDMAP_POPUP_CLOSE    = "WORLDMAP_POPUP_CLOSE";
    }
