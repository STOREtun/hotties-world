...
-(bool) purchaseProduct:(NSString*)requestedProductId
{
    ...
    if (requestedProduct != nil) {
        ...
        [self UnibillSendMessage:@"onProductPurchaseFailed" payload:message];
        return YES;
    }
}
        ...
        switch (transaction.transactionState) {
            ...
            case SKPaymentTransactionStateFailed:
                ...
                if (transaction.error.code != SKErrorPaymentCancelled) {
                    ...
                    [self UnibillSendMessage:@"onProductPurchaseFailed" payload:transaction.payment.productIdentifier];
                } else {
                    NSLog(@"Unibill: purchase cancelled: %@", errorCode);
                    [self UnibillSendMessage:@"onProductPurchaseCancelled" payload:transaction.payment.productIdentifier];
                }
