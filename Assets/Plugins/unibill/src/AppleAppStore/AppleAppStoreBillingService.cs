...
namespace Unibill.Impl {
    ...
    public class AppleAppStoreBillingService : IBillingService {
        ...
        public AppleAppStoreBillingService(UnibillConfiguration db, ProductIdRemapper mapper, IStoreKitPlugin storekit, IUtil util, ILogger logger) {
        ...
        public void onPurchaseSucceeded(string data, string receipt) {
            ...
            biller.onPurchaseSucceeded(productId, appReceipt, transactionId);
        }
